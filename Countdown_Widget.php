<?php
/**
 * Plugin Name: Event Countdown Widget (Fixed)
 */
...
if ( class_exists( 'Tribe__Events__Pro__Countdown_Widget' ) && !class_exists( 'Tribe__Events__Pro__Countdown_Widget_Fixed' ) ) {
	class Tribe__Events__Pro__Countdown_Widget_Fixed extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct( 'tribe-events-countdown-widget', __( 'Events Countdown (Fixed)', 'tribe-events-calendar-pro' ), $widget_ops, $control_ops );
